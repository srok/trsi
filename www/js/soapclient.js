...
{
  if(t.indexOf("__") > 0)
    t=t.substring(0, t.indexOf("__"))+':'+t.substring(t.indexOf("__")+2,t.lenght);
...
SOAPClient._sendSoapRequest = function(url, method, parameters, async, callback, wsdl)
{
    ...
    "xmlns:nsm=\"http://schemas.datacontract.org/2004/07/nsMobileService\" "+
    ...
    soapaction='urn:NanoScada/'+method;
    xmlHttp.setRequestHeader("SOAPAction",soapaction);//'urn:NanoScada/HelloWorld');// );
...
SOAPClient._node2object = function(node, wsdlTypes)
{
    ...
    if(!isarray)
    {
        ...
        for(var i = 0; i < node.childNodes.length; i++)
        {
            ...
            obj[node.childNodes[i].nodeName.replace('a:','')] = p;
        }
        return obj;
    }
    // list node
